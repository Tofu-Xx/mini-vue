class Vue {
  ...
  constructor (opt) {
    ...
    this.#entry(this.el, document.createTreeWalker(this.el, NodeFilter.SHOW_ALL), fn => (this.#activeEffect = fn, fn()));
  }
  #entry(node, walker, effect) {
    ...
    walker.nextNode() && this.#entry(walker.currentNode, walker, effect);
  }
}